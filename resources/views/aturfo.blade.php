...
@section('main_content')
        ...
        <section class="content">
          ...
          <div class="card card-info col-sm-5">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('foupdate',$aturfo->id)}}" method="post">@csrf
              <div class="card-body">
                <div class="form-group row">
                  <label for="" class="col-sm-5 col-form-label">Lokasi</label>
                  <div class="col-sm5">
                    <input type="text" name="lokasi" class="form-control" value="{{ $aturfo->lokasi }}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm5">
                    <input type="text" name="perangkat" class="form-control" value="{{ $aturfo->perangkat }}">
                    <div class="text-danger">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm5">
                    <input type="text" name="ip" class="form-control" value="{{ $aturfo->ip }}">
                    <div class="text-danger">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm5">
                    <input type="text" name="odp" class="form-control" value="{{ $aturfo->odp }}">
                    <div class="text-danger">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm5">
                    <input type="text" name="bandwith" class="form-control" value="{{ $aturfo->bandwith }}">
                    <div class="text-danger">
              ...
              <div class="card-footer">
                ...
                <a href="/fo" class="btn btn-success">Kembali</a>
              </div>
              <!-- /.card-footer -->
            </form>
          </div>
