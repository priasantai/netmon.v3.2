        ...
        <section class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
                          ...
                          <tr>
                            ...
                            <td><span class="tag tag-success text text-primary">
                              ...
                              if (strpos($output, 'Destination net unreachable') !== false) {
                                  ...
                                  </button>&nbsp;<font color='#000000'> - <b>Trouble! Cek Netnumen</b></font>";
                              }
                              ...
                              else
                              {
                                  echo "<button type='button' class='btn btn-success btn-circle'>
                                  <i class='fa fa-question-circle'></i>
                                  </button>&nbsp;<font color='#5CB85C'> - <b>Trouble! Cek Netnumen</b></font>";
                              }
                            ...
                            <td>
                              ...
                              <!-- /.modal -->
                              <a href="/fo/aturfo/{{ $f->id }}" class="btn btn-secondary">Atur</a>
                              <a href="/fo/fodelete/{{ $f->id }}" class="btn btn-danger">Hapus</a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
              ...
              <!-- endtable -->
              <div class="pagination pagination-sm m-0 float-right">{{ $fo->links() }}
              </div>
            <td>
              <a href="/fo/tambahfo" class="btn btn-success">Tambah</a>
            </td>
             </div>
            <!-- /.card-body -->
