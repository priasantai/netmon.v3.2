        ...
        <section class="content">
          ...
          <div class="card">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <!-- /.modal -->
                              <a href="/radio/aturwireless/{{ $f->id }}" class="btn btn-secondary">Atur</a>
                              <a href="/radiodelete/{{ $f->id }}" class="btn btn-danger">Hapus</a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
              ...
              <!-- endtable -->
              <td>
                <a href="/radio/tambahwireless" class="btn btn-success">Tambah</a>
              </td>
              </div>
            <!-- /.card-body -->
